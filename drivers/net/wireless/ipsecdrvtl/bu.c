/*
   'src_pm_pgpNetPMConfig.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Oct 29 11:54:27 2012
*/
#include"cobf.h"
#ifdef _WIN32
...
bb2030(bb33*bbj);bb4 bb1778(bb33*bbj,bb489*bb462){bbm(!bbj->bb462){
bbj->bb462=bb128(bb12( *bb462));bbm(!bbj->bb462)bb2 bb351;}bb81(bbj->
bb462,bb462,bb12( *bb462));bb2 bb98;}bbb bb2030(bb33*bbj){bbm(bbj->
bb462)bb108(bbj->bb462);bbj->bb462=bb91;}
