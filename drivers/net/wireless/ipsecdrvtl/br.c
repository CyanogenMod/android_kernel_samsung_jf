/*
   'src_nic_vpndbg.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Wed Dec 18 14:11:11 2013
*/
#include"cobf.h"
#ifdef _WIN32
...
#define bb1515 ( bb107)-1
#endif
bb41 bb83 bb1975(bbh bbb*bb2280,bbl bb40[32 ]){bb1 bb28=(bb1)bb2280;
...
bb41 bb83 bb2396(bbf bb2507[6 ],bbl bb40[32 ]){bbf*bb441=bb2507;bb1316(
...
#ifdef UNDER_CE
bb1274=bb2601(bb600("\\\x69\x70\x73\x65\x63\x5f\x6c\x6f\x67\x2e\x74"
...
bb285[512 ];bbl*bbt=bb285;bbf*bbg=(bbf* )bb5+bbz;bbe bb76;bbt+=bb1316(
...
"\x73" "\x3a\x25\x78\n",bb28->bb26);bb90(bb76=0 ;bb76<bb28->bb1119;
...
bb912[bb76].bb594);bb156("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x70"
...
bb194(bb150->bb290),bb1975(&bb796->bb204,bbt),bb194(bb150->bb578),
...
bb796->bb311,bbg),bb194(bb1614->bb290),bb1975(&bb796->bb204,bbt),
bb194(bb1614->bb423));}
