/*
   'src_nic_vpndbg.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Oct 29 11:54:27 2012
*/
#include"cobf.h"
#ifdef _WIN32
...
#else
#ifdef bb308
#define bb2535 bb2441
#endif
#define bb1512 ( bb107)-1
#endif
bb41 bb82 bb1975(bbh bbb*bb2280,bbl bb40[32 ]){bb1 bb28=(bb1)bb2280;
bb1317(bb40,"\x25\x64\x2e\x25\x64\x2e\x25\x64\x2e\x25\x64",bb28[0 ],
bb28[1 ],bb28[2 ],bb28[3 ]);bb2 bb40;}bb41 bbd bb2425(bbh bbb*bb2280){
bb1 bb28=(bb1)bb2280;bb2 bb28[0 ]<<24 |bb28[1 ]<<16 |bb28[2 ]<<8 |bb28[3 ];}
bb41 bb82 bb2398(bbf bb2507[6 ],bbl bb40[32 ]){bbf*bb441=bb2507;bb1317(
...
bb1284=bb1512;bbb bb1878(){bbm(bb1284!=bb1512)bb2;
#ifdef UNDER_CE
bb1284=bb2603(bb598("\\\x69\x70\x73\x65\x63\x5f\x6c\x6f\x67\x2e\x74"
"\x78\x74"),bb2616|bb2591,bb2585|bb2651,0 ,bb2637,bb2639,0 );
#else
bb1284=0 ;
#endif
}bbb bb1877(){bbm(bb1284!=bb1512){
#ifdef UNDER_CE
bb2648(bb1284);
#endif
bb1284=bb1512;}}bbb bb156(bbh bbl*bb19,...){bb2530 bb195;bbq bb11;bbl
bb40[256 ];bbm(bb1284==bb1512)bb2;bb2482(bb195,bb19);bb11=bb2535(bb40,
bb12(bb40)-1 ,bb19,bb195);bb40[bb11]=0 ;
#ifdef UNDER_CE
bb2641(bb1284,bb40,bb11,&bb11,bb91);
#else
#ifdef _WIN32
#ifdef bb308
bb2589("\x25\x73",bb40);
#else
bb2647(bb40);bb321("\x25\x73",bb40);
#endif
#else
#ifdef bb308
bb611("\x25\x73",bb40);
...
#ifdef UNDER_CE
bbb bb2000(bb191 bbg){bb191 bb28=bbg;bbm(!bbg){bb156("\x28\x6e\x75"
"\x6c\x6c\x29\n");bb2;}bb106( *bb28){bbm(bb28!=bbg)bb156("\x2c\x20");
bb156("\x25\x6c\x73",bb28);bb28+=bb2601(bb28)+1 ;}bb156("\n");}
#endif
bbb bb2035(bbb*bb2525,bbq bb2524){bbl bb40[256 ];bbl*bb2206=(bbl* )bb2525
;bbl*bb2461=bb2206+bb2524;bbe bb1966=0 ;bbm(bb1284==bb1512)bb2;bb106(
...
"\x73",bb40);}bb156("\n");}bbb bb1964(bbb*bb5,bbq bb10){bbe bb1744=16
;bbq bbz;bbm(bb1284==bb1512)bb2;bb90(bbz=0 ;bbz<bb10;bbz+=bb1744){bbl
bb206[512 ];bbl*bbt=bb206;bbf*bbg=(bbf* )bb5+bbz;bbe bb76;bbt+=bb1317(
bbt,"\x25\x30\x34\x64",bbz);bb90(bb76=0 ;bb76<bb1744;bb76++){bbm(bbz+
bb76+1 <=bb10){bbe bb42=bbg[bb76];bbm(bb76>0 &&bb76%8 ==0 )bbt+=bb1317(
bbt,"\x20\x2d");bbt+=bb1317(bbt,"\x20\x25\x30\x32\x78",bb42);}bb54{
bbm(bb76>0 &&bb76%8 ==0 )bbt+=bb1317(bbt,"\x20\x20");bbt+=bb1317(bbt,""
"\x20\x20\x20");}} *bbt++=' ';bb90(bb76=0 ;bb76<bb1744;bb76++){ *bbt++
=bbz+bb76<bb10?(bbg[bb76]<0x80 &&bb2504(bbg[bb76])?bbg[bb76]:'.'):' ';
} *bbt++='\n'; *bbt=0 ;bb156("\x25\x73",bb206);}}bbb bb1810(bbb*bb5,
bbq bb10){bbe bb1744=16 ;bbq bbz;bbm(bb1284==bb1512)bb2;bb90(bbz=0 ;bbz
<bb10;bbz+=bb1744){bb41 bbl bb206[512 ];bbl*bbt=bb206;bbf*bbg=(bbf* )bb5
+bbz;bbe bb76;bb90(bb76=0 ;bb76<bb1744;bb76++){bbm(bbz+bb76+1 <=bb10){
bbe bb42=bbg[bb76];bbt+=bb1317(bbt,"\x25\x30\x32\x78",bb42);}} *bbt=0
;bb156("\"\x25\x73\"\n",bb206);}}bbb bb1334(bbb*bb5,bbq bb10){bbe
bb1744=16 ;bbq bbz;bbm(bb1284==bb1512)bb2;bb90(bbz=0 ;bbz<bb10;bbz+=
bb1744){bb41 bbl bb206[512 ];bbl*bbt=bb206;bbf*bbg=(bbf* )bb5+bbz;bbe
bb76;bb90(bb76=0 ;bb76<bb1744;bb76++){bbm(bbz+bb76+1 <=bb10){bbe bb42=
bbg[bb76];bbt+=bb1317(bbt,"\\\x78\x25\x30\x32\x78",bb42);}} *bbt=0 ;
bb156("\"\x25\x73\"\n",bb206);}}bbb bb1897(){bb489*bbo=bb934.bb974->
bb462;bb156("\t" "\x62\x50\x47\x50\x6e\x65\x74\x45\x6e\x61\x62\x6c"
"\x65\x64" "\x3a\x25\x64\n",bbo->bb1123);bb156("\t" "\x46\x69\x72\x65"
"\x77\x61\x6c\x6c\x4c\x65\x76\x65\x6c" "\x3a\x25\x64\n",bbo->bb1078);
}bbb bb1748(){bbq bbz;bb33*bb949=bb934.bb974;bb156("\x6e\x75\x6d\x53"
"\x41\x73\x3a\x25\x64\n",bb949->bb539);bb90(bbz=0 ;bbz<bb949->bb539;
bbz++){bb198*bb28=&bb949->bb509[bbz].bb179;bbq bb76;bb156("\x73\x61"
"\x5b\x25\x64\x5d\n",bbz);bb156("\x20\x20" "\x69\x70\x41\x64\x64\x72"
"\x65\x73\x73" "\x3a\x25\x78\n",bb28->bb26);bb90(bb76=0 ;bb76<bb28->
bb1118;bb76++){bb156("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x69\x73"
"\x52\x61\x6e\x67\x65" "\x3a\x25\x78\n",bb76,bb28->bb917[bb76].bb1144
);bb156("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x69\x73\x45\x78\x63"
"\x6c\x75\x64\x69\x6e\x67" "\x3a\x25\x78\n",bb76,bb28->bb917[bb76].
bb1160);bb156("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x61\x64\x64"
"\x72\x53\x74\x61\x72\x74" "\x3a\x25\x78\n",bb76,bb28->bb917[bb76].
bb847);bb156("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x61\x64\x64\x72"
"\x4d\x61\x73\x6b\x4f\x72\x45\x6e\x64" "\x3a\x25\x78\n",bb76,bb28->
bb917[bb76].bb594);bb156("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x70"
"\x72\x6f\x74\x6f\x63\x6f\x6c" "\x3a\x25\x78\n",bb76,bb28->bb917[bb76
].bb102);bb156("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x70\x6f\x72"
"\x74" "\x3a\x25\x78\n",bb76,bb28->bb917[bb76].bb437);}bb156("\x20"
"\x20" "\x6e\x61\x74\x54\x72\x61\x76\x65\x72\x73\x61\x6c" "\x3a\x25"
"\x78\n",bb28->bb503);bb156("\x20\x20" "\x6e\x61\x74\x49\x50\x41\x64"
"\x64\x72\x65\x73\x73" "\x3a\x25\x78\n",bb28->bb1293);bb156("\x20\x20" ""
"\x6e\x62\x6f\x4e\x41\x54\x50\x6f\x72\x74" "\x3a\x25\x78\n",bb28->
bb1067);bb156("\x20\x20" "\x61\x73\x73\x69\x67\x6e\x65\x64\x49\x50" ""
"\x3a\x25\x78\n",bb28->bb557);bb156("\x20\x20" "\x61\x63\x74\x69\x76"
"\x65\x49\x6e" "\x3a\x25\x78\n",bb28->bb1339);bb156("\x20\x20" "\x61"
"\x63\x74\x69\x76\x65\x4f\x75\x74" "\x3a\x25\x78\n",bb28->bb1107);
bb156("\x20\x20\x69\x6e\x53\x50\x49\x3a\x25\x78\n", * (bb29)(bb28->
bb404[0 ]).bb955);bb156("\x20\x20\x6f\x75\x74\x53\x50\x49\x3a\x25\x78"
"\n", * (bb29)(bb28->bb404[0 ]).bb1210);bb156("\x20\x20" "\x74\x72\x61"
"\x6e\x73\x66\x6f\x72\x6d\x5b\x30\x5d\x2e\x70\x72\x6f\x74\x6f\x63\x6f"
"\x6c" "\x3a\x25\x78\n",bb28->bb404[0 ].bb102);bb156("\x20\x20" "\x74"
"\x72\x61\x6e\x73\x66\x6f\x72\x6d\x5b\x30\x5d\x2e\x75\x2e\x65\x73\x70"
"\x2e\x74\x2e\x63\x69\x70\x68\x65\x72" "\x3a\x25\x78\n",bb28->bb404[0
].bb315.bb311.bb45.bb154);bb156("\x20\x20" "\x74\x72\x61\x6e\x73\x66"
"\x6f\x72\x6d\x5b\x30\x5d\x2e\x75\x2e\x65\x73\x70\x2e\x74\x2e\x61\x75"
"\x74\x68\x41\x74\x74\x72" "\x3a\x25\x78\n",bb28->bb404[0 ].bb315.
bb311.bb45.bb589);bb156("\x20\x20" "\x74\x72\x61\x6e\x73\x66\x6f\x72"
"\x6d\x5b\x30\x5d\x2e\x75\x2e\x65\x73\x70\x2e\x74\x2e\x6d\x6f\x64\x65" ""
"\x3a\x25\x78\n",bb28->bb404[0 ].bb315.bb311.bb45.bb57);bb156("\x20"
"\x20\x74\x72\x61\x6e\x73\x66\x6f\x72\x6d\x5b\x30\x5d\x2e\x75\x2e\x65"
"\x73\x70\x2e" "\x69\x6e\x45\x53\x50\x4b\x65\x79" "\n");bb1334(bb28->
bb404[0 ].bb315.bb311.bb1217,bb12(bb28->bb404[0 ].bb315.bb311.bb1217));
...
"\n");bb1334(bb28->bb404[0 ].bb315.bb311.bb1229,bb12(bb28->bb404[0 ].
bb315.bb311.bb1229));bb156("\x20\x20\x74\x72\x61\x6e\x73\x66\x6f\x72"
"\x6d\x5b\x30\x5d\x2e\x75\x2e\x65\x73\x70\x2e" "\x69\x6e\x41\x75\x74"
"\x68\x4b\x65\x79" "\n");bb1334(bb28->bb404[0 ].bb315.bb311.bb554,bb12
(bb28->bb404[0 ].bb315.bb311.bb554));bb156("\x20\x20\x74\x72\x61\x6e"
"\x73\x66\x6f\x72\x6d\x5b\x30\x5d\x2e\x75\x2e\x65\x73\x70\x2e" "\x6f"
"\x75\x74\x41\x75\x74\x68\x4b\x65\x79" "\n");bb1334(bb28->bb404[0 ].
bb315.bb311.bb555,bb12(bb28->bb404[0 ].bb315.bb311.bb555));bb156("\x20"
"\x20\x74\x72\x61\x6e\x73\x66\x6f\x72\x6d\x5b\x30\x5d\x2e\x75\x2e\x65"
"\x73\x70\x2e" "\x65\x78\x70\x6c\x69\x63\x69\x74\x49\x56" "\n");
bb1334(bb28->bb404[0 ].bb315.bb311.bb1200,bb12(bb28->bb404[0 ].bb315.
bb311.bb1200));bb156("\x20\x20" "\x6c\x6f\x63\x61\x6c\x49\x50\x41\x64"
"\x64\x72\x65\x73\x73" "\x3a\x25\x78\n",bb28->bb593);bb156("\x20\x20"
"\x62\x69\x72\x74\x68\x54\x69\x6d\x65\x3a\x25\x78\n",bb949->bb509[bbz
].bb566);bb156("\x20\x20\x6c\x61\x73\x74\x53\x65\x6e\x64\x54\x69\x6d"
"\x65\x3a\x25\x78\n",bb949->bb509[bbz].bb1158);bb156("\x20\x20\x6c"
"\x61\x73\x74\x52\x65\x63\x76\x54\x69\x6d\x65\x3a\x25\x78\n",bb949->
bb509[bbz].bb1169);}}bbb bb1977(bb365*bb1920){bb365*bb2292=bb1920;bbl
...
bb194(bb2292->bb372));}bbb bb1574(bb325*bb28){bbl bbg[32 ],bbt[32 ];
...
"\n",bb28->bb936,bb194(bb28->bb370),bb194(bb28->bb867),bb194(bb28->
bb577),bb28->bb1003,bb28->bb254,bb1975(&bb28->bb309,bbg),bb1975(&bb28
->bb203,bbt));}bb41 bbb bb2469(bbe bbo,bbl bb40[16 ]){bbl*bb28=bb40;
...
bb1263(bb325*bb657,bb490*bb150){bbl bbg[32 ],bbt[32 ],bbo[16 ];bbm(!
bb150)bb150=(bb313)((bb1)bb657+bb657->bb936*4 );bb2469(bb150->bb172,
...
"\x64\x2c\x20\x75\x72\x67\x3a\x25\x64\n",bb1975(&bb657->bb309,bbg),
bb194(bb150->bb226),bb1975(&bb657->bb203,bbt),bb194(bb150->bb583),
bb2425(&bb150->bb547),bb2425(&bb150->bb920),(bb150->bb92&0xf0 )>>2 ,bbo
,bb194(bb150->bb158),bb194(bb150->bb990));}bbb bb1483(bb325*bb657,
bb412*bb1611){bbl bbg[32 ],bbt[32 ];bbm(!bb1611)bb1611=(bb333)((bb1)bb657
+bb657->bb936*4 );bb156("\x75\x64\x70\x20\x73\x72\x63\x3a\x25\x73\x3a"
"\x25\x64\x2c\x20\x64\x65\x73\x74\x3a\x25\x73\x3a\x25\x64\n",bb1975(&
bb657->bb309,bbg),bb194(bb1611->bb226),bb1975(&bb657->bb203,bbt),
bb194(bb1611->bb427));}
