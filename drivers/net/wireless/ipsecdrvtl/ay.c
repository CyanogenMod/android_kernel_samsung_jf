/*
   'src_compress_deflate_inflate.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Wed Dec 18 14:11:10 2013
*/
#include"cobf.h"
#ifdef _WIN32
...
-2 );bby->bb187=bby->bb605=0 ;bby->bb320=0 ;bby->bb23->bb57=bby->bb23->
...
bbe bb20;{bbe bb27;bb7 bbn;bbm(bby==0 ||bby->bb23==0 ||bby->bb127==0 )bb2
(-2 );bb20=bb20==4 ?(-5 ):0 ;bb27=(-5 );bb106(1 )bb300(bby->bb23->bb57){
bb15 bb2327:{bbm(bby->bb148==0 )bb2 bb27;bb27=bb20;}bbm(((bby->bb23->
...
->bb23->bb57=bb2311;bb15 bb2311:{bbm(bby->bb148==0 )bb2 bb27;bb27=bb20
...
bb27;bb27=bb20;}bby->bb23->bb149.bb487.bb1005=(bb24)(bby->bb148--,bby
->bb187++, *bby->bb127++)<<24 ;bby->bb23->bb57=bb2339;bb15 bb2339:{bbm
(bby->bb148==0 )bb2 bb27;bb27=bb20;}bby->bb23->bb149.bb487.bb1005+=(
bb24)(bby->bb148--,bby->bb187++, *bby->bb127++)<<16 ;bby->bb23->bb57=
bb2340;bb15 bb2340:{bbm(bby->bb148==0 )bb2 bb27;bb27=bb20;}bby->bb23->
 ...
 * )"";bby->bb23->bb149.bb1741=0 ;bb2(-2 );bb15 bb2089:bb27=bb1981(bby
->bb23->bb1643,bby,bb27);bbm(bb27==(-3 )){bby->bb23->bb57=bb920;bby->
bb23->bb149.bb1741=0 ;bb22;}bbm(bb27==0 )bb27=bb20;bbm(bb27!=1 )bb2 bb27
;bb27=bb20;bb1791(bby->bb23->bb1643,bby,&bby->bb23->bb149.bb487.
bb2323);bbm(bby->bb23->bb2041){bby->bb23->bb57=bb1785;bb22;}bby->bb23
->bb57=bb2357;bb15 bb2357:{bbm(bby->bb148==0 )bb2 bb27;bb27=bb20;}bby
->bb23->bb149.bb487.bb1005=(bb24)(bby->bb148--,bby->bb187++, *bby->
bb127++)<<24 ;bby->bb23->bb57=bb2358;bb15 bb2358:{bbm(bby->bb148==0 )bb2
bb27;bb27=bb20;}bby->bb23->bb149.bb487.bb1005+=(bb24)(bby->bb148--,
bby->bb187++, *bby->bb127++)<<16 ;bby->bb23->bb57=bb2359;bb15 bb2359:{
bbm(bby->bb148==0 )bb2 bb27;bb27=bb20;}bby->bb23->bb149.bb487.bb1005+=
(bb24)(bby->bb148--,bby->bb187++, *bby->bb127++)<<8 ;bby->bb23->bb57=
bb2356;bb15 bb2356:{bbm(bby->bb148==0 )bb2 bb27;bb27=bb20;}bby->bb23->
bb149.bb487.bb1005+=(bb24)(bby->bb148--,bby->bb187++, *bby->bb127++);
...
bby->bb148=bb11;bby->bb23->bb149.bb1741=bb97;bbm(bb97!=4 )bb2(-3 );bb27
=bby->bb187;bbv=bby->bb605;bb1009(bby);bby->bb187=bb27;bby->bb605=bbv
