/*
   'src_pm_pgpNetPMEvents.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Wed Dec 18 14:11:11 2013
*/
#include"cobf.h"
#ifdef _WIN32
...
bb160*bb314,bbu bb592,bbu bb944);bbu bb1870(bb307*bbj,bbq bb502);bbb
...
bbj);bbm(bbj->bb914){bb108(bbj->bb914);bbj->bb914=bb91;}bbj->bb502=0 ;
bb143(&bbj->bb979);}bbb bb1960(bb307*bbj){bb32(bbj);bb134(&bbj->bb979
);bbj->bb385=0 ;bbj->bb451=0 ;bb132(&bbj->bb979);}bbu bb1790(bb307*bbj,
bb405*bb625){bbu bb27=0 ;bb32(bb625&&bbj);bbm(bbj->bb914&&bb625){bb134
(&bbj->bb979);{bbd bb502=bbj->bb502;bbm(bbj->bb451+1 >bb502){bbj->
bb385=(bbj->bb385+1 )%bb502;bbj->bb451--;}bb81(bbj->bb914+(bbj->bb385+
bbj->bb451++)%bb502,bb625,bb12( *bb625));bb27=1 ;}bb132(&bbj->bb979);}
bb2 bb27;}bbu bb1930(bb307*bbj,bb405*bb625){bbu bb27=0 ;bb32(bb625);
bbm(bbj&&bbj->bb914&&bb625){bb134(&bbj->bb979);bbm(bbj->bb451){bbd
bb502=bbj->bb502;bb81(bb625,bbj->bb914+bbj->bb385,bb12( *bb625));bbj
->bb385=(bbj->bb385+1 )%bb502;bbj->bb451--;bb27=1 ;}bb132(&bbj->bb979);
}bb2 bb27;}bbb bb1933(bb33*bbj,bb178 bb104){bb405 bb97={0 };bb1239*
...
}bbb bb1817(bb33*bbj,bbd bb26,bbd bb945){bb405 bb97={0 };bb1258*bb28=(
bb1258* )bb97.bb1215;bb97.bb129=bb1359;bb28->bb26=bb26;bb28->bb945=
