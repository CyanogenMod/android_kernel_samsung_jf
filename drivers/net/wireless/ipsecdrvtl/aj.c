/*
   'kmd.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Oct 29 11:54:27 2012
*/
#include"cobf.h"
#ifdef _WIN32
...
#endif
bbb bb2144(bb522*bbj,bbe bb131){bb2029 bbn={0 };bbn.bb131=bb131;bb300(
bb131&0xff00 ){bb15 0x1000 :{bb492*bb2238=(bb492* )bbj->bbt;bb1961(
bb2238,bb131&0xff );bbn.bb38=bb2238->bbn.bb38;bbn.bb389=bb2238->bbn.
bb389;}bbn.bb887=(bb1865)bb2006;bbn.bb180=(bb828)bb1988;bbn.bb704=(
bb765)bb2007;bb21;bb15 0x2000 :bbn.bb38=16 ;bbn.bb389=16 ;bbn.bb887=(
bb1865)bb2042;bbn.bb180=(bb828)bb2093;bbn.bb704=(bb765)bb2103;bb21;
bb416:bb32(0 );}bbj->bbn=bbn;}bbb bb2170(bb522*bbj,bbh bbb*bb71,bbq
bb143){bbj->bbn.bb887(bbj->bbt,bb71,bb143);}bbb bb1834(bb522*bbj,bbe
bb131,bbh bbb*bb71,bbq bb143){bb2144(bbj,bb131);bb2170(bbj,bb71,bb143
);}bbb bb1243(bb522*bbj,bbh bbb*bb5,bbq bb10){bbj->bbn.bb180(bbj->bbt
,bb5,bb10);}bbb bb1816(bb522*bbj,bbb*bb14){bbj->bbn.bb704(bbj->bbt,
bb14);}bbb bb2166(bbe bb131,bbh bbb*bb71,bbq bb143,bbb*bb14,bbh bbb*
bb5,bbq bb10){bb522 bb95;bb1834(&bb95,bb131,bb71,bb143);bb1243(&bb95,
bb5,bb10);bb1816(&bb95,bb14);}bbb bb2195(bbe bb131,bb82 bb71,bbb*bb14
,bb82 bb5){bb2166(bb131,bb71,(bbq)bb1305(bb71),bb14,bb5,(bbq)bb1305(
bb5));}bb82 bb2205(bbe bb131){bb41 bbl bbg[32 ];bb300(bb131&0xff00 ){
bb15 0x1000 :bb1317(bbg,"\x48\x4d\x41\x43\x5f\x25\x73",bb1970(bb131&
