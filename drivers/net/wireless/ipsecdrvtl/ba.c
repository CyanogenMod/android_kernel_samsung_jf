/*
   'src_compress_deflate_infutil.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Oct 29 11:54:27 2012
*/
#include"cobf.h"
#ifdef _WIN32
...
{bbe bb445;};bbi bb1232{bbe bb445;};bbe bb394(bbg,bby,bb27)bb302*bbg;
bb17 bby;bbe bb27;{bb7 bb11;bb30*bb28;bb30*bb84;bb28=bby->bb596;bb84=
bbg->bb371;bb11=(bb7)((bb84<=bbg->bb199?bbg->bb199:bbg->bb442)-bb84);
bbm(bb11>bby->bb384)bb11=bby->bb384;bbm(bb11&&bb27==(-5 ))bb27=0 ;bby->
bb384-=bb11;bby->bb615+=bb11;bbm(bbg->bb1559!=0 )bby->bb368=bbg->bb473
=( *bbg->bb1559)(bbg->bb473,bb84,bb11);bb81(bb28,bb84,bb11);bb28+=
bb11;bb84+=bb11;bbm(bb84==bbg->bb442){bb84=bbg->bb158;bbm(bbg->bb199
==bbg->bb442)bbg->bb199=bbg->bb158;bb11=(bb7)(bbg->bb199-bb84);bbm(
bb11>bby->bb384)bb11=bby->bb384;bbm(bb11&&bb27==(-5 ))bb27=0 ;bby->
bb384-=bb11;bby->bb615+=bb11;bbm(bbg->bb1559!=0 )bby->bb368=bbg->bb473
=( *bbg->bb1559)(bbg->bb473,bb84,bb11);bb81(bb28,bb84,bb11);bb28+=
bb11;bb84+=bb11;}bby->bb596=bb28;bbg->bb371=bb84;bb2 bb27;}
