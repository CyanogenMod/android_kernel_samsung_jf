/*
   'src_compress_deflate_zutil.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Oct 29 11:54:27 2012
*/
#include"cobf.h"
#ifdef _WIN32
...
bb914));bbh bbl*bb1070[10 ]={"\x6e\x65\x65\x64\x20\x64\x69\x63\x74\x69"
...
"\x69\x6f\x6e",""};bbi bb381{bbe bb445;};
#ifndef bb136
bbr bbb bb2643 bbp((bbe));
#endif
bbh bbl*bb1159(){bb2"\x31\x2e\x31\x2e\x33";}bbh bbl*bb1170(bb18)bbe
bb18;{bb2 bb1070[2 -(bb18)];}
#ifdef __TURBOC__
#if ( defined( __BORLANDC__) || ! defined( bb1549)) && ! defined(  \
bb399)
#define bb2321
#define bb2402 10
bb41 bbe bb2015=0 ;bba bbi bb2646{bb70 bb2375;bb70 bb2403;}bb2510;bb41
bb2510 bb1023[bb2402];bb70 bb1168(bb70 bb110,bbs bb495,bbs bb47){bb70
bb40=bb110;bb393 bb2261=(bb393)bb495*bb47;bbm(bb2261<65520L ){bb40=
bb1344(bb2261);bbm( * (bb125* )&bb40!=0 )bb2 bb40;}bb54{bb40=bb1344(
bb2261+16L );}bbm(bb40==bb91||bb2015>=bb2402)bb2 bb91;bb1023[bb2015].
bb2375=bb40; * ((bb125* )&bb40+1 )+=((bb125)((bb155* )bb40-0 )+15 )>>4 ; *
(bb125* )&bb40=0 ;bb1023[bb2015++].bb2403=bb40;bb2 bb40;}bbb bb1163(
bb70 bb110,bb70 bb914){bbe bb11;bbm( * (bb125* )&bb914!=0 ){bb1318(
bb914);bb2;}bb90(bb11=0 ;bb11<bb2015;bb11++){bbm(bb914!=bb1023[bb11].
bb2403)bb1684;bb1318(bb1023[bb11].bb2375);bb106(++bb11<bb2015){bb1023
[bb11-1 ]=bb1023[bb11];}bb2015--;bb2;}bb914=bb110;;}
#endif
#endif
#if defined( bb2640) && ! defined( bb399)
#define bb2321
#if (! defined( _MSC_VER) || ( _MSC_VER <= 600))
#define bb2446 bb2622
#define bb2558 bb2649
#endif
bb70 bb1168(bb70 bb110,bbs bb495,bbs bb47){bbm(bb110)bb110=0 ;bb2
bb2446((bb6)bb495,bb47);}bbb bb1163(bb70 bb110,bb70 bb914){bbm(bb110)bb110
=0 ;bb2558(bb914);}
#endif
#ifndef bb2321
#ifndef bb136
bbr bb182 bb137 bbp((bb7 bb495,bb7 bb47));bbr bbb bb108 bbp((bb70
bb914));
#endif
bb70 bb1168(bb110,bb495,bb47)bb70 bb110;bbs bb495;bbs bb47;{(bbb)bb110
;(bbb)bb495;(bbb)bb47;;bb2 bb91;}bbb bb1163(bb110,bb914)bb70 bb110;
bb70 bb914;{(bbb)bb110;(bbb)bb914;;bb2;}
#endif
