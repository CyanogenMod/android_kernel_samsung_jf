/*
   'src_compress_deflate_inffast.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Wed Dec 18 14:11:10 2013
*/
#include"cobf.h"
#ifdef _WIN32
...
bb7 bb2395;bb7 bb2397;bb7 bbo;bb7 bbt;bb30*bb27;{{bb28=bby->bb127;
...
bb3-=(bb45->bb508.bb509.bb959);}; *bb84++=(bb152)bb45->bb604;bb97--;
bb1690;}bb565{{bbn>>=(bb45->bb508.bb509.bb959);bb3-=(bb45->bb508.
bb509.bb959);}bbm(bbw&16 ){bbw&=15 ;bbo=bb45->bb604+((bb7)bbn&bb1145[
...
bb11--, *bb28++))<<bb3;bb3+=8 ;}}bbt=bb45->bb604+((bb7)bbn&bb1145[bbw]
...
-=bbw;bb565{ *bb84++= *bb27++;}bb106(--bbw);bb27=bbg->bb158;}}bb565{ *
bb84++= *bb27++;}bb106(--bbo);bb22;}bb54 bbm((bbw&64 )==0 ){bb45+=bb45
->bb604;bbw=(bb45+=((bb7)bbn&bb1145[bbw]))->bb508.bb509.bb1171;}bb54{
...
bb45->bb604;bbm((bbw=(bb45+=((bb7)bbn&bb1145[bbw]))->bb508.bb509.
bb1171)==0 ){{bbn>>=(bb45->bb508.bb509.bb959);bb3-=(bb45->bb508.bb509.
bb959);}; *bb84++=(bb152)bb45->bb604;bb97--;bb22;}}bb54 bbm(bbw&32 ){;
