/*
   'crt.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Oct 29 11:54:27 2012
*/
#include"cobf.h"
#ifdef _WIN32
...
#endif
#ifdef _WIN32
bbb*bb128(bb31 bb47){bb41 bb2599 bb2377=bb2614(-1 ,-1 );
#ifdef UNDER_CE
...
);bbm(bb28)bb999(bb28,0 ,bb47);bb2 bb28;}
#endif
#ifndef _WIN32
bbe bb144(bbh bbl*bb97,bbh bbl*bb25,bbs bb206){bb611(bb2608"\x61\x73"
"\x73\x65\x72\x74\x20\x66\x61\x69\x6c\x75\x72\x65\x3a\x20\x25\x73\x2c"
"\x20\x25\x73\x28\x25\x64\x29\n",bb97,bb25,bb206);bb2 0 ;}
#endif
bb43 bb301(bb43*bb323){bb43 bb45;
#ifdef _WIN32
bb2572 bb2089;bb2613(&bb2089);bb45=(bb43)((bb2089.bb2605-
116444736000000000i64 )/10000000i64 );
#else
bbi bb2631 bb2089;bb2576(&bb2089);bb45=(bb43)bb2089.bb2602;
#endif
bbm(bb323) *bb323=bb45;bb2 bb45;}
#ifndef _WIN32
bbe bb327(bbh bbl*bbg){bb611("\x25\x73\n",bbg);bb2 0 ;}bbe bb321(bbh
bbl*bb19,...){bbl bb40[256 ];bbe bb11;bb2530 bb195;bb2482(bb195,bb19);
bb11=bb2441(bb40,bb12(bb40)-1 ,bb19,bb195);bb40[bb12(bb40)-1 ]=0 ;bb611(""
