/*
   'src_compress_deflate_adler32.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Oct 29 11:54:27 2012
*/
#include"cobf.h"
#ifdef _WIN32
...
#endif
bb24 bb986(bb368,bb40,bb22)bb24 bb368;bbh bb30*bb40;bb7 bb22;{bbd
bb196=bb368&0xffff ;bbd bb338=(bb368>>16 )&0xffff ;bbe bb3;bbm(bb40==0 )bb2
1L ;bb106(bb22>0 ){bb3=bb22<5552 ?bb22:5552 ;bb22-=bb3;bb106(bb3>=16 ){{
bb196+=bb40[0 ];bb338+=bb196;};{bb196+=bb40[0 +1 ];bb338+=bb196;};;{
bb196+=bb40[0 +2 ];bb338+=bb196;};{bb196+=bb40[0 +2 +1 ];bb338+=bb196;};;;
{bb196+=bb40[0 +4 ];bb338+=bb196;};{bb196+=bb40[0 +4 +1 ];bb338+=bb196;};;
{bb196+=bb40[0 +4 +2 ];bb338+=bb196;};{bb196+=bb40[0 +4 +2 +1 ];bb338+=bb196
;};;;;{bb196+=bb40[8 ];bb338+=bb196;};{bb196+=bb40[8 +1 ];bb338+=bb196;}
;;{bb196+=bb40[8 +2 ];bb338+=bb196;};{bb196+=bb40[8 +2 +1 ];bb338+=bb196;}
;;;{bb196+=bb40[8 +4 ];bb338+=bb196;};{bb196+=bb40[8 +4 +1 ];bb338+=bb196;
};;{bb196+=bb40[8 +4 +2 ];bb338+=bb196;};{bb196+=bb40[8 +4 +2 +1 ];bb338+=
bb196;};;;;;bb40+=16 ;bb3-=16 ;}bbm(bb3!=0 )bb573{bb196+= *bb40++;bb338
+=bb196;}bb106(--bb3);bb196%=65521L ;bb338%=65521L ;}bb2(bb338<<16 )|
bb196;}
