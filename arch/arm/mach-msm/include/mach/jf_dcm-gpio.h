...
#define GPIO_MHL_SCL                    GPIO_SHARED_I2C_SCL
#define GPIO_MHL_SDA                    GPIO_SHARED_I2C_SDA
...
#define PMIC_MAIN_MICBIAS_EN		-1
#define PMIC_GPIO_EAR_MICBIAS_EN        -1
#define PMIC_GPIO_2MIC_RST              16
#define PMIC_GPIO_SPK_EN                18
#define PMIC_GPIO_VPS_EN                19
#define PMIC_GPIO_FSA8048_EN			28
#define PMIC_GPIO_IRDA_WAKE             40   /* Did not allocated PMIC_GPIO 40 */
